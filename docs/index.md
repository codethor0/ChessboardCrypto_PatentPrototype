...
Public research and proof-of-concept documentation index.
...
Statistical checks are engineering sanity checks inspired by NIST SP 800-22. They are not formal NIST validation, certification, or proof of cryptographic security.
...
This index is suitable for GitHub Pages rendering from the `/docs` folder if enabled in repository settings. No Jekyll theme is required for basic Markdown rendering.
